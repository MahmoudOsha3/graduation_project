                ...
                <div class="col-xl-4 col-md-6 col-lg-4">
                    <div class="single_department">
                        ...
                        <div class="department_content">
                            <h3><a wire:click.prevent="loadDoctors({{ $special->id }})">
                                {{ $special->name }}
                            </a></h3>

                            {{-- <h3><a href="{{ route('department.doctor' , $special->id ) }}">{{ $special->name }}</a></h3> --}}
        ...
        <div class="expert_doctors_area doctor_page" >
            <div class="container">
                @if ($nameSpecialization)
                    <h2 style="font-weight:bold ; text-align:center">Department : {{ $nameSpecialization }}</h2><br>
                @else
                                ...
                                <a href="{{ route('site.doctor-profile' , $doctor->id) }}">
                                    <div class="single_expert mb-40">
                                        <div class="expert_thumb">
                                            <img src="{{ asset('images/'."$doctor->image") }}" alt="" style="height:250px">
                                        </div>

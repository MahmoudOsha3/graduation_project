                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="padding: 0 20px;">
                            <h1 style="margin-bottom: 20px; color: #333;">Welcome {{ $patient }}</h1>
                            <p style="margin-bottom: 20px; color: #666;">We hope you are well</p>
                            <p style="margin-bottom: 20px; color: #666;">We want to tell you that your appointment has been confirmed with <br> Dr / {{ $doctor }} <br>date : {{ $date }}  <br>day : {{ $day }} <br>oclock : {{ $oclock }} pm</p>

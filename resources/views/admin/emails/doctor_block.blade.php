                ...
                <table style="width: 100%;">
                    <tr>
                        <td style="text-align: center;">
                            <img src="{{ asset('/images/website/logo.jpg') }}" alt="Logo" style="max-width: 150px; margin-bottom: 20px;">
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 0 20px;">
                            <h1 style="margin-bottom: 20px; color: #333;">Welcome {{ $name }}</h1>
                            <p style="margin-bottom: 20px; color: #666;">We hope you are well</p>
                            <p style="margin-bottom: 20px; color: #666;">We want to tell you that your account has been banned for not following the platform policy . you can contact us for help you</p>

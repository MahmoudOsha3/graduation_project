...
<div class="wrapper">
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="<?php echo e(asset('images/'.auth()->user()->image)); ?>" class="user-image" alt="User Image">
    ...
    <?php echo $__env->make('layouts.DashboardDoctor._aside', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\Projects Laravel\projects\doctor appointment\resources\views/layouts/DashboardDoctor/app.blade.php ENDPATH**/ ?>
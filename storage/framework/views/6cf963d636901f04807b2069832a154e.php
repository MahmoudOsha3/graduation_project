		...
		<div class="login-box">
			...
			<div class="card card-outline card-primary">
			  	...
			  	<div class="card-body">
					...
					<form action="<?php echo e(route('check.admin.login')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\Projects Laravel\E-commerce v2\e-commerce\resources\views/admin/login.blade.php ENDPATH**/ ?>
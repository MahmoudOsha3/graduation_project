                ...
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="padding: 0 20px;">
                            <h1 style="margin-bottom: 20px; color: #333;">Welcome <?php echo e($patient); ?></h1>
                            <p style="margin-bottom: 20px; color: #666;">We hope you are well</p>
                            <p style="margin-bottom: 20px; color: #666;">We want to tell you that your appointment has been confirmed with <br> Dr / <?php echo e($doctor); ?> <br>date : <?php echo e($date); ?>  <br>day : <?php echo e($day); ?> <br>oclock : <?php echo e($oclock); ?> pm</p>
...
<?php /**PATH D:\Projects Laravel\projects\doctor appointment\resources\views/website/emails/Confirm_booking.blade.php ENDPATH**/ ?>
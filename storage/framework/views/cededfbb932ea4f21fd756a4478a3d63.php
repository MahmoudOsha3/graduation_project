...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo e(route('check.website.login')); ?>" method="post">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <a href="<?php echo e(route('view.website.register')); ?>" class="text-center">Register a new membership</a>
...
<?php /**PATH D:\Projects Laravel\projects\doctor appointment\resources\views/website/auth/login.blade.php ENDPATH**/ ?>
    ...
    <div class="box box-primary">
        ...
        <div class="box-body">
            ...
            <form action="<?php echo e(route('doctors.store')); ?>" method="Post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="bio"><?php echo app('translator')->get('site.bio'); ?></label> 
                ...
                <div class="form-group">
                    <label for="clinic"><?php echo app('translator')->get('site.clinic'); ?></label>
                    <select name="clinic_id" id="clinic" class="form-control">
                        <option value="<?php echo e(null); ?>" disabled>...</option>
                        <?php $__currentLoopData = $clinics; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $clinic): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($clinic->id); ?>"><?php echo app('translator')->get('site.number'); ?>:<?php echo e($clinic->id); ?> ====== <?php echo e($clinic->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.dashboard.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects Laravel\projects\doctor appointment\resources\views/dashboard/doctors/create.blade.php ENDPATH**/ ?>